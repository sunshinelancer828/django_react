...
from apps.master.urls import master_urlpatterns
from apps.testing.urls import testing_urlpatterns
from apps.analytics.urls import analytics_urlpatterns
from apps.settings.urls import settings_urlpatterns
